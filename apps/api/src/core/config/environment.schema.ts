...
export const environmentSchema = z.object({
  ...
  OPERATOR_DATABASE_URL: z.string({ required_error: "OPERATOR_DATABASE_URL is required" }).min(1, "OPERATOR_DATABASE_URL is required"),
  ...
  BREVO_SENDER_NAME: z.string().min(1).default("Firecrawl Gateway"),
